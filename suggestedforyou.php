    ...
    <div class="clearfix">
        <div class="column">
            ...
            <div class="content column">
                ...
                <p>Our website features a suggestion developing algorithm that will generate a suggested location for you to read about or to travel to.
                    The suggested location will de displayed below. Please feel free to give us feedback on the suggested destination using the
                    <a href="contactus.html">contact us </a>feature on the site.</p>
            </div>
        </div>
    </div>
